...
// ELEMENT DEFAULTS
const DEFAULTS = {
  camera: { img: './images/camera.webp', label: 'Cam', color: '#4a9eff', size: 36 },
  fresnel: { img: './images/fresnel.webp', label: 'Fresnel', color: '#ffcc44', size: 36 },
  led: { img: './images/led.webp', label: 'LED', color: '#ffcc44', size: 36 },
